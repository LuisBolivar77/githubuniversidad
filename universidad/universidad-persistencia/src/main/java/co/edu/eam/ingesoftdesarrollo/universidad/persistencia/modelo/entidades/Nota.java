...
@Table(name = "tb_nota")
@NamedQueries({
		@NamedQuery(name = Nota.ESTUDIANTE_NOTA, query = "SELECT n FROM Nota n JOIN n.cedulaEstudiante r WHERE r.estudiante = ?1"),
		@NamedQuery(name = Nota.NOTA_ESTUDIANTE, query = "SELECT n FROM Nota n JOIN n.cedulaEstudiante r WHERE r.estudiante=?1 AND n.evaluacion=?2"),
		@NamedQuery(name = Nota.NOTAS_EN_EVALUACION, query = "SELECT n FROM Nota n JOIN n.evaluacion e WHERE e.nombre = ?1")
		})
public class Nota implements Serializable {
	 ...
	 */
	public static final String ESTUDIANTE_NOTA = "Nota.notasEstudiante";
	 ...
	 * ?2: La evaluaci�n
	 */
	public static final String NOTA_ESTUDIANTE = "Nota.calificacionEstudiante";
	
	/**
	 * Obtiene las notas que hay en una evaluaci�n
	 * ?1: el nombre de la Evaluaci�n
	 */
	public static final String NOTAS_EN_EVALUACION = "Nota.notasEvaluacion";
