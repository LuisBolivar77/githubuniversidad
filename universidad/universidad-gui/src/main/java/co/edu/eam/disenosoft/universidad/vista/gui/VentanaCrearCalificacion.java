...
public class VentanaCrearCalificacion extends javax.swing.JInternalFrame {
	...
	private void btnAgregarCalificacionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAgregarCalificacionActionPerformed
		...
		try {
			if (comboCurso.getSelectedIndex() == 0) {
				...
				JOptionPane.showMessageDialog(null, "Se agreg� una evaluaci�n");
	...
	private void btnQuitarCalificacionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnQuitarCalificacionActionPerformed
		...
		try {
			...
			if (fila < 0) {
				JOptionPane.showMessageDialog(null, " Debe seleccionar evaluacion ");
			} else {
				Curso c = (Curso) comboCurso.getSelectedItem();
				...
				JOptionPane.showMessageDialog(null, "Se elimin� la evaluaci�n");
				double sumatoria = adminCalificaciones.sumatoriaPorcentaje(c, asignBuscada);
				tfporcentajenoasignado.setText(100 - sumatoria + "%");
				refrescarTabla(c);
			}
