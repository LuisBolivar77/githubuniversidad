...
public class ControladorAdministrarProfesor {
	 ...
	 * @param cedula codula del profesor que se desea buscar
	 ...
	 * @param ced codula del profesor que se desea eliminar
	 * @throws Exception en caso de que falle la operacion
	 */
	...
	/**
	 * Busca un profesion por su codigo
	 * @param cod codigo de la profesion que se desea buscar
	 * @return la profesion si la encuenta, de lo contrario null
