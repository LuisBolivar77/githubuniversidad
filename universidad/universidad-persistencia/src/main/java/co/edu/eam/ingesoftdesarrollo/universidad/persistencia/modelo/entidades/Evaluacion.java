...
@NamedQueries({
		@NamedQuery(name = Evaluacion.PORCENTAJES_EVALUACION, query = "SELECT SUM(e.porcentaje) FROM Evaluacion e JOIN e.curso c JOIN c.asignatura a WHERE c = ?1 AND a = ?2"),
...
public class Evaluacion implements Serializable {
	 ...
	 * ?1: curso donde est� la asignatura
	 * ?2: la asignatura
	 */
	public static final String PORCENTAJES_EVALUACION = "Evaluacion.sumatoriaPorcentaje";
