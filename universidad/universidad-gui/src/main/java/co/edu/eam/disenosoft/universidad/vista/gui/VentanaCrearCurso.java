...
public class VentanaCrearCurso extends javax.swing.JInternalFrame {
	...
	private Asignatura asigBus;
	private Curso cursoActual;
	private Profesor profesorEncontrado;
	...
	private void btnBuscarDocenteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarDocenteActionPerformed
		...
		try {
			...
			profesorEncontrado = adminCurso.buscarDocente(ced);

			if (profesorEncontrado != null) {
				tfnombredocente.setText(profesorEncontrado.getNombre());
			} else {
	...
	private void btnQuitarSesionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnQuitarSesionActionPerformed
		...
		try {
			...
			if (pos >= 0) {
				int opc = JOptionPane.showConfirmDialog(null, "Esta seguro que desea eliminar esta sesi�n");
				if (opc == 0) {
					cursoActual.getSesiones().remove(pos);
					adminCurso.eliminarSesCurso(cursoActual);
					llenarTablaSesionCurso();
					JOptionPane.showMessageDialog(null, "Se elimin� la sesi�n");
				}
			} else {
				JOptionPane.showMessageDialog(null, "debe seleccionar una sesi�n de la tabla");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void btnBuscarAsignaturaActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			asigBus = adminCurso.buscarAsignatura(cod);

			if (asigBus != null) {
				tfnombreasignatura.setText(asigBus.getNombre());
			} else {
	...
	private void btnAgregarSesionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAgregarSesionActionPerformed
		...
		try {
			...
			if (cursoActual == null) {
				...
				llenarTablaSesionCurso();
				JOptionPane.showMessageDialog(null, "Se cre� la sesi�n");
			}
	...
	private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnCrearActionPerformed
		...
		try {
			String cod = jTFCodigoCurso.getText();
			if (profesorEncontrado != null && asigBus != null) {
				Curso c = new Curso(cod, profesorEncontrado, asigBus);
				cursoActual = c;
				adminCurso.crearCurso(c);
				JOptionPane.showMessageDialog(null, "Se cre� un curso");
			} else {
				JOptionPane.showMessageDialog(null, "Se debi� haber buscado previamente un docente y una asignatura");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			if (cursoActual != null) {
				if (!jTFCodigoCurso.getText().isEmpty()) {
					if (asigBus != null || profesorEncontrado != null) {
						cursoActual.setAsignatura(asigBus);
						cursoActual.setProfesor(profesorEncontrado);
						cursoActual.setCodigo(jTFCodigoCurso.getText());
						adminCurso.editarCurso(cursoActual);
					} else {
						JOptionPane.showMessageDialog(null, " Debe buscar una asignatura y un curso antes de editar");
					}
				} else {
					JOptionPane.showMessageDialog(null, " Debe llenar el campo de codigo de curso");
				}
			} else {
	...
	/**
	 * Llena el combo d�a de la ventana
	 */
