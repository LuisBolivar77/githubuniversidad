...
public class VentanaProfesor extends javax.swing.JInternalFrame implements ActionListener {
	...
	/**
	 * Adminstra los eventos de acci�n realizados en los botones de administrar
	 * docente
	 */
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnCrear) {
			...
			try {
				if (tfApellido.getText().isEmpty() || tfCEdula.getText().isEmpty() || tfCorreo.getText().isEmpty()
						|| tfDireccion.getText().isEmpty() || tfNombre.getText().isEmpty()
						|| tfTelefono.getText().isEmpty() ) {
					JOptionPane.showMessageDialog(null, " Debe llenar los campos para crear ");
				} else {
					...
					if (index == 0) {
						JOptionPane.showMessageDialog(null, "Debe seleccionar un tipo de profesi�n");
					} else {
		...
		if (arg0.getSource() == btnBuscar) {
			...
			try {
				...
				if (ced.isEmpty()) {
					JOptionPane.showMessageDialog(null, " Debe ingresar la cedula para poder buscar ");
				} else {
		...
		if (arg0.getSource() == btnEliminar) {
			...
			try {
				...
				if (!tfCEdula.getText().isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "debe ingresar un n�mero de c�dula");
				}
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
	...
	public void refrescarCombo() {
		...
		try {
			...
			cbProfesion.addItem("Seleccione una opci�n");
