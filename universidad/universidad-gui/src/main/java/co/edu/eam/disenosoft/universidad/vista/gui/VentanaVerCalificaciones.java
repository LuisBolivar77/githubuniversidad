...
public class VentanaVerCalificaciones extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(5, 5, 5).addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel2).addComponent(tfcodigoasignatura,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel4).addComponent(comboCurso,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		tablaNotas.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null, null } },
				new String[] { "Cedula", "Nombre", "Nota 1", "Nota 2", "..", "...", "Nota N", "Definitiva" }));
	...
	private void comboCursoItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_comboCursoItemStateChanged
		...
		try {
			if (comboCurso.getSelectedIndex() != 0) {
				...
				List<Estudiante> estudiantes = controlador.estudiantesCurso(c);
				List<Nota> notas = null;
				for (Estudiante estudiante : estudiantes) {
					notas = controlador.notasEstudiante(estudiante);
				}
				nombreCampos(notas);
				refrescarTabla(c);
			}
	...
	private void btnBuscarAsignaturaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarAsignaturaActionPerformed
		...
		try {
			...
			Asignatura a = controlador.buscarAsignatura(cod);
	...
	private void refrescarCombo(Asignatura a) {
		try {
			List<Curso> lista = controlador.cursosAsignatura(a);
	...
	private void refrescarTabla(Curso c) {
		try {
			...
			dtm.setRowCount(0);
			List<Estudiante> estudiantes = controlador.estudiantesCurso(c);
			ArrayList<String> listarTabla = new ArrayList<String>();
			for (Estudiante lista : estudiantes) {
				List<Nota> notas = controlador.notasEstudiante(lista);
				double definitiva = controlador.calificacionEstudiante(notas);
				listarTabla.add(lista.getNombre());
				listarTabla.add(lista.getCedula());
				for (int i = 0; i < notas.size(); i++) {
					if (notas.get(i) == null) {
						listarTabla.add("NC");
					} else {
						listarTabla.add(notas.get(i).getValor() + "");
					}
				}
				listarTabla.add(definitiva + "");
				// dtm.addRow(new Object[] { lista.getCedula(),
				// lista.getNombre(),nota, nota, nota, definitiva });
			}
			dtm.addRow(listarTabla.toArray());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	private void nombreCampos(List<Nota> notas) {
		DefaultTableModel tabla = (DefaultTableModel) tablaNotas.getModel();
		ArrayList<String> nombres = new ArrayList<String>();
		nombres.add("Nombre");
		nombres.add("Cédula");
		for (int i = 0; i < notas.size(); i++) {
			nombres.add(notas.get(i).getEvaluacion().getNombre());
		}
